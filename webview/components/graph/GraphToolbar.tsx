          ...
          <>
            <button
              className={cn(
                ...
                showInput && !pendingStepMode
                  ? 'bg-node-success/30 text-node-success ring-1 ring-node-success/50'
                  : 'bg-node-success/20 text-node-success hover:bg-node-success/30'
              )}
              onClick={handleRun}
              title="Run graph"
            >
            ...
            <button
              className={cn(
                'flex items-center gap-1 text-xs px-3 py-1 rounded transition-colors',
                showInput && pendingStepMode
                  ? 'bg-node-active/30 text-node-active ring-1 ring-node-active/50'
                  : 'bg-node-active/20 text-node-active hover:bg-node-active/30'
              )}
              onClick={handleStep}
